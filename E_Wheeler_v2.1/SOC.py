...
def on_connect(client, userdata, flags, rc):
    client.subscribe([("93/bms/vol",0),("93/bms/current",0),("93/bms/soc",0)])
...
def on_message(client, userdata, msg):
    ...
    if (str(msg.topic) == '93/bms/vol') :
        VOLTAGE_READ = float(msg.payload)
        #print(VOLTAGE_READ)
    elif (str(msg.topic) == '93/bms/current') :
        CURRENT_READ = float(msg.payload)
        #print(CURRENT_READ)
    elif (str(msg.topic) == '93/bms/soc') :
        SOC_VALUE = float(msg.payload)
        #print(SOC_VALUE)
            ...
            while True:
                if ser.in_waiting > 0:
                    ...
                    if ( data != b'' and data != b'\r\n'):
                        ...
                        publish.single("93/bms/temp",25,hostname = "localhost")
        except:
...
class BatteryRead:
    def __init__( self):
        ...
        self.soh = 0.87
        self.soc = 0.91 #Assumed full charged
